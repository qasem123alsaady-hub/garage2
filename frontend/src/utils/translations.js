export const translations = {
  ar: {
    ...
    technicianUsername: "اسم المستخدم",
    technicianEmail: "البريد (اختياري)",
    technicianPassword: "كلمة المرور",
    add: "إضافة",
    cancel: "إلغاء",
  ...
  en: {
    ...
    searchPlaceholder: "Search for vehicle by make, model, or license plate...",
    printReport: "Print Report",
    close: "Close",
    technicianName: "Name",
    technicianUsername: "Username",
    technicianEmail: "Email (Optional)",
